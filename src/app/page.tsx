      ...
      <main className="pt-24 pb-24 overflow-hidden">
        ...
        <section className="max-w-7xl mx-auto px-6 pt-32 pb-32">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://wa.me/?text=Mirá%20esta%20herramienta%20para%20calcular%20precios%20de%20hacienda%3A%20https%3A%2F%2Fwww.consignatarias.com.ar%2Fcalculadora"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 text-sm text-emerald-400 hover:text-emerald-300 transition-colors"
            >
