...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/quiero-comprar`, lastModified: buildDate, changeFrequency: 'weekly', priority: 0.8 },
    ...
    { url: `${baseUrl}/que-es-el-dte`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/que-es-senasa`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${baseUrl}/calendario-sanitario-bovino`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/que-es-el-rosgan`, lastModified: priceDate, changeFrequency: 'daily', priority: 0.75 },
    // 3 rutas que el race de edits paralelos dejó sin registrar (agregadas a mano).
    { url: `${baseUrl}/como-funciona-un-remate-ganadero`, lastModified: priceDate, changeFrequency: 'daily', priority: 0.75 },
    { url: `${baseUrl}/que-es-el-destete`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.65 },
    { url: `${baseUrl}/que-es-la-capitalizacion-de-hacienda`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.65 },
    // Tanda 4 — tier-3 práctico/comparativo + pilar de venta.
    { url: `${baseUrl}/vender-hacienda-guia`, lastModified: priceDate, changeFrequency: 'daily', priority: 0.85 },
    { url: `${baseUrl}/precio-de-tranquera`, lastModified: priceDate, changeFrequency: 'daily', priority: 0.8 },
    { url: `${baseUrl}/como-leer-una-liquidacion-de-hacienda`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${baseUrl}/cuanto-cobra-de-comision-una-consignataria`, lastModified: priceDate, changeFrequency: 'daily', priority: 0.78 },
    { url: `${baseUrl}/cuanto-cuesta-el-flete-de-hacienda`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${baseUrl}/desbaste-de-la-hacienda`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/conviene-vender-la-hacienda-ahora-o-esperar`, lastModified: priceDate, changeFrequency: 'daily', priority: 0.8 },
    { url: `${baseUrl}/como-sacar-el-boleto-de-marca`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/que-es-la-guia-de-hacienda`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.68 },
    { url: `${baseUrl}/que-es-una-tropa-de-hacienda`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${baseUrl}/como-se-calcula-la-carga-animal`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/que-es-el-equivalente-vaca`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.65 },
    { url: `${baseUrl}/feedlot-vs-pastoril`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.68 },
    { url: `${baseUrl}/vender-en-remate-vs-venta-directa-vs-consignacion`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.72 },
    {
