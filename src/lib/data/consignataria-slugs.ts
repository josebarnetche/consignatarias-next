...
const PROFILES: ConsignatariaProfile[] = [
  ...
  { canonicalSlug: 'ganaderos-de-ceres', displayName: 'Ganaderos de Ceres Coop. Ltda.', allSlugs: ['ganaderos-de-ceres', 'ganaderos-de-ceres-cooperativa-ltda', 'ganaderos-de-ceres-coop-ltda'] },
  ...
  { canonicalSlug: 'hk-agro', displayName: 'HK Agro SRL', allSlugs: ['hk-agro', 'hk-agro-s-r-l'] },
  ...
  { canonicalSlug: 'javier-ulises-avalos', displayName: 'Javier Ulises Avalos', allSlugs: ['javier-ulises-avalos', 'javier-u-avalos'] },
  ...
  { canonicalSlug: 'productores-rurales-sud', displayName: 'Productores Rurales del Sud Coop. Ltda.', allSlugs: ['productores-rurales-sud', 'productores-rurales-del-sud-coop-ltda'] },
  ...
  { canonicalSlug: 'saenz-valiente-bullrich', displayName: 'Saenz Valiente, Bullrich y Cia. SA', allSlugs: ['saenz-valiente-bullrich', 'saenz-valiente-bullrich-y-cia-', 'saenz-valiente-bullrich-y-cia-s-a', 'alfredo-cavanagh', 'saenz-valiente-bullrich-2020'] },
  ...
  { canonicalSlug: 'umc-villaguay', displayName: 'UMC SA - Haciendas Villaguay SRL', allSlugs: ['umc-villaguay', 'umc-haciendas-villaguay', 'u-m-c-s-a', 'haciendas-villaguay-s-r-l'] },
  ...
  { canonicalSlug: 'esteban-abelenda', displayName: 'Esteban Abelenda SA', allSlugs: ['esteban-abelenda', 'esteban-abelenda-s-a', 'esteban-i-abelenda-s-a', 'esteban-i-abelenda'] },
