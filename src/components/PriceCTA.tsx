...
export function PriceCTA() {
  return (
    <div className="terminal-panel mb-6" style={{ borderColor: 'rgba(16,185,129,0.30)' }}>
      <div className="px-panel py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex shrink-0 flex-wrap gap-2">
          <Link
            href="/calculadora"
            className="rounded border border-emerald-500/30 bg-emerald-500/10 px-3 py-1.5 text-xs font-medium text-emerald-400 transition-colors hover:bg-emerald-500/20"
          >
            Calcular neto →
          </Link>
          <Link
