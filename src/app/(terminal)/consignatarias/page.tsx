...
export const metadata: Metadata = {
  ...
  description: 'Directorio completo de 88 consignatarias de hacienda en Argentina. Calendario de remates, provincias, contacto. Ordená por cantidad de remates o nombre.',
  keywords: [
  ...
  openGraph: {
    title: 'Directorio de 88 Consignatarias | Consignatarias.com.ar',
