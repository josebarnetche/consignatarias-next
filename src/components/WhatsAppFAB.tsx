...
export default function WhatsAppFAB({ whatsapp, consignatariaName, slug, className = '' }: WhatsAppFABProps) {
  ...
  // Pre-filled message
  const message = `Hola! Vi su perfil de ${consignatariaName} en consignatarias.com.ar y me gustaría consultar sobre sus próximos remates.`
  ...
  return (
    <a
      ...
      className={`
        ...
        text-white font-terminal text-sm font-medium uppercase tracking-wider
        rounded-full
        ...
        ${className}
      `}
      aria-label={`Contactar ${consignatariaName} por WhatsApp`}
    >
      {/* WhatsApp Icon */}
      <svg 
        viewBox="0 0 24 24" 
