...
export const CONSIGNATARIA_BRANDS: Record<string, { logo: string; color: string; keepColor?: boolean; whiteLogo?: boolean }> = {
  ...
  'cooperativa-guillermo-lehmann': { logo: 'cooperativa-guillermo-lehmann.png', color: '#00924d', whiteLogo: true },
  ...
  'jauregui-lorda': { logo: 'jauregui-lorda.png', color: '#f2b705', whiteLogo: true },
  // umc-villaguay omitted: multicolor mascot, doesn't read as a clean white logo.
  'etchevehere-rural': { logo: 'etchevehere-rural.png', color: '#0e2f60', whiteLogo: true },
  ...
  'reggi': { logo: 'reggi.png', color: '#001830', whiteLogo: true },
  ...
  'casa-usandizaga': { logo: 'casa-usandizaga.png', color: '#d81818', whiteLogo: true },
  ...
  'lalor': { logo: 'lalor.png', color: '#183060', whiteLogo: true },
  'monasterio-tattersall': { logo: 'monasterio-tattersall.png', color: '#186030' },
  'wallace-hnos': { logo: 'wallace-hnos.png', color: '#e1251b', whiteLogo: true },
  'paz-hnos': { logo: 'paz-hnos.png', color: '#24a4db', whiteLogo: true },
  'esteban-abelenda': { logo: 'esteban-abelenda.png', color: '#b33a3a', whiteLogo: true },
